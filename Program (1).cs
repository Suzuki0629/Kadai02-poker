...
namespace Kadai2_1
{
    class Program
    {
        ...
        static void Yakuhantei()
        {
            ...
            // スリーカード
            else if (number[0] == 3 || number[1] == 3 || number[2] == 3 || number[3] == 3 || number[4] == 3)
            {
                Console.WriteLine("スリーカード");
            }
            // フォーカード
            else if (number[0] == 4 || number[1] == 4 || number[2] == 4 || number[3] == 4 || number[4] == 4)
            {
                Console.WriteLine("フォーカード");
            }
            // ワンペア
            else if (number[0] == 2 || number[1] == 2 || number[2] == 2 || number[3] == 2 || number[4] == 2)
            {
